 ...
 *   node export.js <input.drawio> --final        # Final export (-e -s 4, embeds XML)
...
Options:
  --final         Final export with -e -s 4 (embeds editable XML in PNG)
...
Modes:
  ...
  Final (--final):    drawio -x -f png -e -s 4 -o <input>.drawio.png <input>
`);
        process.exit(0);
    }
