...
```
<shape-prefix>;fillColor=<palette[slot].fillColor>;strokeColor=<palette[slot].strokeColor>;fontFamily=<font.fontFamily>;fontSize=<font.fontSize>;fontColor=<extras.fontColor or palette[slot].fontColor>;
```
